...
Winner = Room("Winner",
"""
Congratulations, you have completed all the tasks and tests in this game.
Your are very capable to move away from home!!
""", "winner.jpg")



generic_death = Room("out", "You couldn't do it!", "gameover.jpg")

kitchen_out = Room("out",
"""
I'm sorry, you are out of this game!
""", "gameover.jpg")
